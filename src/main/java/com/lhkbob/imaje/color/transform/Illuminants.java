...
return new Yyx(luminance, 0.29902, 0.31485);
  ...
  public static Yyx newCorrelatedColorTemperature(double temp, double luminance) {
    ...
    double x;
    if (temp <= 4000) {
      x = -0.2661239 * 1e9 / (temp * temp * temp) - 0.2343580 * 1e6 / (temp * temp) + 0.8776956 * 1e3 / temp + 0.179910;
    } else {
  ...
  public static Yyx fromIlluminant(Illuminant illum) {
    ...
    switch (illum.type()) {
    case A: return newA(l);
    case B: return newB(l);
    case C: return newC(l);
    case D50: return newD50(l);
    case D55: return newD55(l);
    case D65: return newD65(l);
    case D75: return newD75(l);
    case E: return newE(l);
    case F1: return newF1(l);
    case F2: return newF2(l);
    case F3: return newF3(l);
    case F4: return newF4(l);
    case F5: return newF5(l);
    case F6: return newF6(l);
    case F7: return newF7(l);
    case F8: return newF8(l);
    case F9: return newF9(l);
    case F10: return newF10(l);
    case F11: return newF11(l);
    case F12: return newF12(l);
    case TEMPERATURE: return newCorrelatedColorTemperature(illum.temperature(), l);
    case CHROMATICITY: return new Yyx(l, illum.chromaticity().x(), illum.chromaticity().y());
    default:
