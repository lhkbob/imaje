...
import static com.lhkbob.imaje.color.icc.transforms.XYZToLabTransform.f;

/**
 *
 */
public class XYZToLuvTransform implements ColorTransform {
  private final GenericColorValue referenceWhitepoint;
  private final double uWhite, vWhite;

  public XYZToLuvTransform(GenericColorValue referenceWhitepoint) {
  ...
  @Override
  public LuvToXYZTransform inverted() {
    return new LuvToXYZTransform(referenceWhitepoint);
  }
