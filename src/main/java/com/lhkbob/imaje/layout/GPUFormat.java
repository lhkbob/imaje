...
public enum GPUFormat {
  ...
  R8G8_SRGB(
      byte.class, true, repeat(8, 2), repeat(Type.UNORM, 2),
      new Channel[] { Channel.R, Channel.G }),
  ...
  R8G8B8_SRGB(byte.class, true, repeat(8, 3), repeat(Type.UNORM, 3), rgb()),
  ...
  B8G8R8_SRGB(byte.class, true, repeat(8, 3), repeat(Type.UNORM, 3), bgr()),
  ...
  R8G8B8A8_SRGB(byte.class, true, repeat(8, 4), repeat(Type.UNORM, 4), rgba()),
  ...
  B8G8R8A8_SRGB(byte.class, true, repeat(8, 4), repeat(Type.UNORM, 4), bgra()),
